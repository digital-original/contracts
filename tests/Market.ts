...
describe('Market', function () {
    ...
    it(`should have correct initial order count`, async () => {
        await expect(market.ordersCount()).to.eventually.equal(0n);
    });
    ...
    describe(`method 'onERC721Received'`, () => {
        ...
        it(`should increase order count`, async () => {
            ...
            await expect(market.ordersCount()).to.eventually.equal(1);
        });
        ...
        it(`should fail if signature is expired`, async () => {
            ...
            await expect(placeOrder({ _deadline })).to.be.rejectedWith('EIP712ExpiredSignature');
        });
    ...
    describe(`method 'cancel'`, () => {
        ...
        beforeEach(async () => {
            ...
            orderId = (await market.ordersCount()) - 1n;
